...
<body>
								...
								<td>
									<table class="table table-bordered">
										<thead>
											<tr>
												<th>類別：企業</th>
												<c:forEach items="${verifyMap}" var="object">
							...
							<tr>
								<td>
									<table class="table table-bordered">
										...
										<tbody>
											<c:forEach items="${verifyMap}" var="object">
												<c:if test="${object.key == 'verifyList'}">
													<c:forEach items="${object.value}" var="enterprise">
														<tr>
															<td>
																<button type="button" class="btn btn-info" data-id="${enterprise.guid}" data-toggle="modal" data-target="#tryonModal">通過</button> /
																<button type="button" class="btn btn-info" data-id="${enterprise.guid}" id="fail" data-toggle="modal" data-target="#failModal">不通過</button> /
	...
	<!-- tryonModal -->
	<div id="tryonModal" class="modal fade" role="dialog">
		<div class="modal-dialog">
			<!-- Modal content-->
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title">是否檢核通過!?</h4>
				</div>
				<div class="modal-body">
					<center>
						<button type="button" class="btn btn-default" id="effectiveSubmit" onclick="tryonModalDone();">確定</button>
	...
	<div id="failModal" class="modal fade" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title">是否檢核不通過!?</h4>
				</div>
				<div class="modal-body">
				...
				<div class="modal-footer">
					<center>
						<button type="button" class="btn btn-default" onclick="failModalDone();">確定</button>
						<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
					</center>
				</div>
			</div>
									...
									<td colspan="2">
										<div class="form-group">
											...
											<select class="form-control" id="selectGeneral">
												<option>請選擇</option>
												<c:forEach items="${verifyMap}" var="obj">
